  ...
  return (
    <div className="min-h-screen bg-[#070B12] text-white flex items-center justify-center relative overflow-hidden font-sans">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-[#7C5CFF] opacity-10 rounded-full blur-[150px]" />
      </div>
      ...
      >
        <div className="text-center mb-10">
          <motion.div 
            ...
            className="w-20 h-20 bg-gradient-to-br from-[#14F1D9]/20 to-[#7C5CFF]/20 rounded-3xl mx-auto flex items-center justify-center border border-white/5 shadow-[0_0_40px_rgba(20,241,217,0.15)] mb-6"
          >
          ...
          <p className="text-[#8B9AB4] text-sm">
            Student Safety & Emergency Portal
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="relative group">
            ...
            <input
              ...
              placeholder="Student Email (e.g., student@college.edu)"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={isPending}
            className="w-full bg-[#14F1D9] hover:bg-[#14F1D9]/90 text-[#070B12] font-semibold py-4 rounded-2xl transition-all shadow-[0_0_20px_rgba(20,241,217,0.3)] hover:shadow-[0_0_30px_rgba(20,241,217,0.5)] flex items-center justify-center space-x-2 disabled:opacity-70 disabled:cursor-not-allowed group"
          >
            {isPending ? (
        ...
        <form onSubmit={handleSubmit} className="mt-4">
          <input type="hidden" name="email" value="demo@campusshield.edu" />
